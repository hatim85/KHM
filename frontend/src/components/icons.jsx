...
/**
 * Dependency-free Lucide-style icon set (24×24, stroke-based).
 * Same visual language as lucide-react without the install.
 */
const Svg = ({ size = 18, className = '', strokeWidth = 2, children }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const PackageIcon = (p) => (
  <Svg {...p}>
    ...
    <path d="M12 22V12" />
    <path d="m3.3 7 7.7 4.41a2 2 0 0 0 2 0L20.7 7" />
...
export const BoxesIcon = (p) => (
  <Svg {...p}>
    <path d="M2.97 12.92A2 2 0 0 0 2 14.63v3.24a2 2 0 0 0 .97 1.71l3 1.8a2 2 0 0 0 2.06 0L12 19v-5.5l-5.03-3.03a2 2 0 0 0-2-.01Z" />
    <path d="M12 19v-5.5l5.03-3.03a2 2 0 0 1 2-.01l3 1.8a2 2 0 0 1 .97 1.71v3.24a2 2 0 0 1-.97 1.71l-3 1.8a2 2 0 0 1-2.06 0Z" />
    <path d="M12 13.5V4a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v3.24a2 2 0 0 0 .97 1.71l3 1.8a2 2 0 0 0 2.06 0Z" />
  </Svg>
);
