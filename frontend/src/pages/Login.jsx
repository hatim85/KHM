...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-white dark:via-slate-900 to-indigo-950 flex items-center justify-center p-3 sm:p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        {/* Card */}
        <div className="bg-white dark:bg-slate-900/80 backdrop-blur-2xl border border-slate-200 dark:border-slate-800/80 rounded-2xl sm:rounded-3xl p-6 sm:p-10 shadow-2xl shadow-black/50">
          {/* Header */}
