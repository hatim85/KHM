    ...
    <div className="space-y-6">
      ...
      <div className="bg-slate-900/60 border border-slate-800 rounded-2xl p-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          <button className="flex flex-col items-center justify-center p-4 bg-slate-800/60 hover:bg-indigo-600/20 hover:border-indigo-500/40 border border-slate-700/60 rounded-xl transition text-center group">
            <span className="text-2xl mb-1.5 group-hover:scale-110 transition-transform">📄</span>
            <span className="text-xs font-semibold text-white">New Estimated Bill</span>
          </button>
          <button className="flex flex-col items-center justify-center p-4 bg-slate-800/60 hover:bg-indigo-600/20 hover:border-indigo-500/40 border border-slate-700/60 rounded-xl transition text-center group">
            <span className="text-2xl mb-1.5 group-hover:scale-110 transition-transform">🧾</span>
            <span className="text-xs font-semibold text-white">New Tax Invoice</span>
          </button>
          <button className="flex flex-col items-center justify-center p-4 bg-slate-800/60 hover:bg-indigo-600/20 hover:border-indigo-500/40 border border-slate-700/60 rounded-xl transition text-center group">
            <span className="text-2xl mb-1.5 group-hover:scale-110 transition-transform">📦</span>
            <span className="text-xs font-semibold text-white">Record Purchase</span>
          </button>
          <button className="flex flex-col items-center justify-center p-4 bg-slate-800/60 hover:bg-indigo-600/20 hover:border-indigo-500/40 border border-slate-700/60 rounded-xl transition text-center group">
            <span className="text-2xl mb-1.5 group-hover:scale-110 transition-transform">💵</span>
            <span className="text-xs font-semibold text-white">Receive Payment</span>
          </button>
        </div>
      </div>
    </div>
