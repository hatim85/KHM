            ...
            <table className="w-full text-left border-collapse whitespace-nowrap min-w-[1000px]">
              <thead>
                <tr className="bg-slate-100 dark:bg-slate-800/40 border-b border-slate-200 dark:border-slate-800">
                  ...
                  <th className="py-4 px-4 text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider w-32 text-right">Taxable</th>
                  <th className="py-4 px-4 text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider w-24 text-right">GST %</th>
                  <th className="py-4 px-4 text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider w-24 text-right">Tax Amt</th>
                  <th className="py-4 px-4 text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider w-32 text-right">Total (₹)</th>
              ...
              {isIntraState ? (
                <>
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-sm text-slate-900 dark:text-white font-mono">₹{totalCgst.toFixed(2)}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-slate-500 dark:text-slate-400">SGST</span>
                    <span className="text-sm text-slate-900 dark:text-white font-mono">₹{totalSgst.toFixed(2)}</span>
                  </div>
                </>
              ) : (
                <div className="flex justify-between items-center">
                  <span className="text-sm text-slate-500 dark:text-slate-400">IGST</span>
                  <span className="text-sm text-slate-900 dark:text-white font-mono">₹{totalIgst.toFixed(2)}</span>
                </div>
              )}
